...
If a custom message is specified with the `message` property, will use that message when reporting occurrences of the syntax specified in the `selector` property.
