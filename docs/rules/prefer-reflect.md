...
This rule was **deprecated** in v3.9.0 and will not be replaced. The original intent of this rule now seems misguided as we have come to understand that `Reflect` methods are not actually intended to replace the `Object` counterparts the rule suggests, but rather exist as low-level primitives to be used with proxies in order to replicate the default behavior of various previously existing functionality.
...
```js
/*prefer-reflect: ["error", { "exceptions": ["apply"] }]*/
...
```js
/*prefer-reflect: ["error", { "exceptions": ["getOwnPropertyDescriptor"] }]*/
...
```js
/*prefer-reflect: ["error", { "exceptions": ["getPrototypeOf"] }]*/
...
```js
/*prefer-reflect: ["error", { "exceptions": ["setPrototypeOf"] }]*/
...
```js
/*prefer-reflect: ["error", { "exceptions": ["isExtensible"] }]*/
...
```js
/*prefer-reflect: ["error", { "exceptions": ["preventExtensions"] }]*/
