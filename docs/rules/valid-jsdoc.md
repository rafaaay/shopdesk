...
This rule was [**deprecated**](https://eslint.org/blog/2018/11/jsdoc-end-of-life) in v5.10.0.
...
```js
/*valid-jsdoc: ["error", { "preferType": { "Boolean": "boolean", "Number": "number", "object": "Object", "String": "string" } }]*/
/*eslint-env es6*/
...
```js
/*valid-jsdoc: ["error", { "requireReturnType": false }]*/
...
```js
/*valid-jsdoc: ["error", { "requireParamType": false }]*/
