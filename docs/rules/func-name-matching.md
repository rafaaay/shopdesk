...
```js
/*func-name-matching: "error"*/
/*func-name-matching: ["error", "always"]*/ // these are equivalent
/*eslint-env es6*/
...
/*func-name-matching: ["error", "always", { "considerPropertyDescriptor": true }]*/ // these are equivalent
var obj = {};
...
/*func-name-matching: ["error", "always", { "includeCommonJSModuleExports": true }]*/ // these are equivalent
