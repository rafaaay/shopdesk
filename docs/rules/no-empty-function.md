...
```js
/*no-empty-function: ["error", { "allow": ["generatorFunctions"] }]*/
/*eslint-env es6*/
...
```js
/*no-empty-function: ["error", { "allow": ["generatorMethods"] }]*/
/*eslint-env es6*/
...
```js
/*no-empty-function: ["error", { "allow": ["getters"] }]*/
/*eslint-env es6*/
...
```js
/*no-empty-function: ["error", { "allow": ["setters"] }]*/
/*eslint-env es6*/
